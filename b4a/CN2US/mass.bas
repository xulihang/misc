...
Sub EditText3_TextChanged (Old As String, New As String)
	If i=3 And New<>"" Then
		EditText1.Text=EditText3.Text*1000*0.454
		EditText2.Text=EditText1.Text/28.35
	End If
End Sub
Sub EditText2_TextChanged (Old As String, New As String)
	If i=2 And New<>"" Then
		EditText1.Text=EditText2.Text*28.35
		EditText3.Text=EditText1.Text/1000/0.454
	End If
End Sub
