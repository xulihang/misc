...
Public Sub DesignerCreateView (Base As Panel, Lbl As Label, Props As Map)
	...
	sv.Color=Colors.ARGB(255,215,218,192)
	'sv.SetBorder(0,Colors.White,0)
...
Public Sub InsertAt(Index As Int, Pnl As Panel, ItemHeight As Int, Value As Object)
	...
	Dim p As Panel
	p.Initialize("panel")
	'p.SetBorder(0,Colors.White,0.5)
...
Public Sub InsertAtTextItem(Index As Int, Text As String, Value As Object)
	...
	Dim line As ImageView
	line.Initialize("")
	line.Color=Colors.White
	pnl.AddView(line,3dip,lbl.Top+lbl.Height,100%x-6dip,1dip)
	InsertAt(Index, pnl, lbl.Height + 4dip, Value)
End Sub
