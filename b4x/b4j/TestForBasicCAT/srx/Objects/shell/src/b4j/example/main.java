...
public static RemoteObject _rules = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
public static b4j.example.srx _srx = null;
public static b4j.example.utils _utils = null;
  public Object[] GetGlobals() {
		return new Object[] {"fx",main._fx,"MainForm",main._mainform,"rules",main._rules,"SRX",Debug.moduleToString(b4j.example.srx.class),"TextArea1",main._textarea1,"Utils",Debug.moduleToString(b4j.example.utils.class)};
}
}